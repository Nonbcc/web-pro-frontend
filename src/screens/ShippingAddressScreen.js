  ...
  return (
    <div className='shipping_image'>
      <div>
        ...
        <img className='card_img_left' src='../images/cart_left.jpg' alt=''></img>
            <div className='card_background_body'>
                <form className='form' onSubmit={submitHandler}>
                        <h1 className='shipping_topic'>Shipping Address</h1>
                    ...
                    <div>
                        <label htmlFor='chooseOnMap'>Location: <button className='map_button' type='button' onClick={chooseOnMap}>
                            <LocationOnIcon className='location_logo'/>
                        </button></label>
                    </div>
                    <div>
                        <label/>
